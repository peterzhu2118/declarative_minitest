# Declarative Minitest [![Build Status](https://travis-ci.org/peterzhu2118/declarative_minitest.svg?branch=master)](https://travis-ci.org/peterzhu2118/declarative_minitest)
